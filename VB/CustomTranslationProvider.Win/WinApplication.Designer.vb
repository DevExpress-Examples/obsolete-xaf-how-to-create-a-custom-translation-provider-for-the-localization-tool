...
Namespace CustomTranslationProvider.Win
	Partial Public Class CustomTranslationProviderWindowsFormsApplication
		''' <summary> 
		...
		Private Sub InitializeComponent()
			...
			Me.googleTranslatorProviderModule1 = New GoogleTranslatorProvider.GoogleTranslatorProviderModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=CustomTranslationProvider;Integrated Security" & "=SSPI;Pooling=false"
			Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
			' 
			' CustomTranslationProviderWindowsFormsApplication
			' 
			Me.ApplicationName = "CustomTranslationProvider"
			...
			Me.Modules.Add(Me.googleTranslatorProviderModule1)
			Me.Security = Me.securitySimple1
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.CustomTranslationProviderWindowsFormsApplication_DatabaseVersionMismatch);
		...
		Private googleTranslatorProviderModule1 As GoogleTranslatorProvider.GoogleTranslatorProviderModule
	End Class
End Namespace
