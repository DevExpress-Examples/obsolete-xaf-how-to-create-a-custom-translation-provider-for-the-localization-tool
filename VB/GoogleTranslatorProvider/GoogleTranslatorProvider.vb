...
Namespace GoogleTranslatorProvider
    Public Class GoogleTranslatorProvider
        ...
        Private Shared GoogleLanguages() As String = {"sq", "ar", "bg", "zh", "ca", "hr", "cs", "da", _
        "nl", "en", "et", "fi", "fr", "gl", "de", "el", "he", "hi", "hu", "id", "it", "ja", "co", "lv", _
        "lt", "mt", "nn", "fa", "pl", "pt", "ro", "ru", "es", "sr", "sk", "sl", "sl", "sv", "th", "tr", _
        "uk", "vi"}
        Public Sub New()
            MyBase.New("<br />", 5000)
        End Sub
        Friend Shared Function CalculatePairSeparatorsBlocks(ByVal text As String) _
            ...
            Do While index < text.Length
                ...
                For i As Integer = 0 To leftSeparators.Length - 1
                    ...
                    Else
                        ...
                        If separatorIndex >= 0 AndAlso (leftSeparatorIndex < 0 _
                        OrElse separatorIndex < leftSeparatorIndex) Then
                            iSeparator = i
                            leftSeparatorIndex = separatorIndex
                ...
                If leftSeparatorIndex >= 0 Then
                    rightSeparatorIndex = text.IndexOf(rightSeparators(iSeparator), _
                    leftSeparatorIndex + leftSeparatorSize)
        ...
        Protected Function TranslateCore(ByVal text As String, ByVal sourceLanguageCode As String, _
        ByVal desinationLanguageCode As String) As String
            ...
            CType(System.Net.WebRequest.Create(serviceUri), System.Net.HttpWebRequest)
            ...
            Return resp
        End Function
        Friend Shared Function GetPropertyValueFromJson(ByVal text As String, _
        ByVal propertyName As String) As String
            ...
            ElseIf text.Chars(indexValueStart) >= "0"c AndAlso _
            text.Chars(indexValueStart) <= "9"c Then
                index = indexValueStart
                Dim number As String = String.Empty
                Do While text.Chars(index) >= "0"c AndAlso _
                text.Chars(index) <= "9"c AndAlso index < text.Length
        ...
        Friend Shared Function DecodeASCIIToUnicode(ByVal text As String) As String
            ...
            Do While unicodeSymbolIndex >= 0
                ...
                Dim unicodeChar As Char = ChrW(Convert.ToInt32(unicodeCharStringCode, 16))
        ...
        Public Overrides Function CalculateSentences(ByVal text As String) As IEnumerable(Of String)
            ...
            Dim lineBlocks As IEnumerable(Of String) = _
...
#Region "ITranslatorProvider Members"
        ...
        End Function
        Public Overrides Function Translate(ByVal text As String, ByVal sourceLanguageCode As String, _
        ByVal desinationLanguageCode As String) As String
